...
var Engine = (function(global) {
    ...
    function stopScreen() {
        ctx.beginPath();
        ctx.fillStyle = "black";
        ctx.rect(0,200,canvas.width,120);
        ctx.fill();

        ctx.font = "bold 20pt Verdana";
        ctx.fillStyle = "red";
        ctx.fillText("Game Over. Your score: " + player.points, 10, 250);
        ctx.fillText("Reload page to start new game." , 10, 300);
